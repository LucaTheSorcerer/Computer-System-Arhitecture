...
; Programul va folosi functia fopen pentru deschiderea/crearea fisierului si functia f close pentru inchiderea fisierului creat
...
segment data use32 class=data
    ...
    mod_acces db "w", 0 ;modul de deschidere a fisierului
                        ;w - pentru scriere, daca fisierul nu exista, se va crea
